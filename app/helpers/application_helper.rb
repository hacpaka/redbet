...
module ApplicationHelper
	...
	def javascript_heads
		tags = javascript_include_tag('jquery-2.2.4-ui-1.11.0-ujs-5.2.3', 'tribute-3.7.3.min', 'application', 'responsive', 'tab_override', 'default')
	...
	def favicon
		"<link rel='shortcut icon' type='image/png' href='#{favicon_path}' />".html_safe
	end
	...
	def favicon_url
		...
		path = favicon_path
		base = url_for(:controller => 'my', :action => 'index', :only_path => false)
